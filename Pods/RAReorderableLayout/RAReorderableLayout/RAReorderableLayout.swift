...
public class RAReorderableLayout: UICollectionViewFlowLayout, UIGestureRecognizerDelegate {
    ...
    private func setUpGestureRecognizers() {
        ...
        pinchGesture = UIPinchGestureRecognizer(target: self, action: #selector(RAReorderableLayout.handlePinchGesture(_:)))
        ...
        gestures.enumerateObjectsUsingBlock { gestureRecognizer, index, finish in
            ...
            //collectionView.addGestureRecognizer(self.pinchGesture!)
        }
    }
    ...
    // pinch gesture
    func handlePinchGesture(pan: UIPinchGestureRecognizer!) {
        
        var scaleStart: CGFloat = pinchScale
        var scale: CGFloat = pinchScale
    ...
    public override func collectionViewContentSize() -> CGSize {
        ...
        contentSize = CGSizeMake(pinchScale * contentSize.width, pinchScale * contentSize.height)
        return contentSize
    }
    */
}
